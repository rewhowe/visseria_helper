    ...
    characters: {
      'Albatross Grand': {
        ...
        abilities: {
          passive: {
            name: 'Endure',
            effect: 'Any DMG Albatross Grand receives is reduced by #room. When Albatross Grand uses an Ultimate ability: this ability is negated',
          },
          active: {
          ...
          ultimate: {
            ...
            effect: 'Enemies can only attack Albatross Grand. Any DMG Albatross Grand receives is reduced by #spec DMG. This ability lasts until Albatross Grand becomes active',
            recharge: 7,
          },
        },
      },
      'T4O MKII': {
        ...
        abilities: {
          passive: {
            name: 'Welded Will',
            effect: 'T4O MKII cannot be debuffed with Bleed or Fear. T4O MKII gains #spec Max HP',
          },
          active: {
            name: 'Self Destruct',
      ...
      'Lilith': {
        ...
        abilities: {
          ...
          active: {
            name: 'Blood Drain',
            effect: 'If an active Enemy is debuffed with Bleed, remove the debuff: deal #spec DMG to that Enemy. Lilith Recovers #spec HP',
          },
          ultimate: {
            name: 'Vampirism',
    ...
    characters: {
      'Harmony Marx': {
        ...
        abilities: {
          passive: {
            name: 'Tempo',
            effect: 'When Harmony Marx attacks an enemy: Harmony Marx gains + #spec Success roll. This effect stacks but resets when Harmony Marx leaves the current Room, Dies or uses an ability',
          },
          active: {
            name: 'Song of Silence',
            effect: 'Success roll: debuff #spec Enemies with Silence until Harmony Marx becomes active',
          },
          ultimate: {
            name: 'Da Capo',
      ...
      'Ariadne': {
        ...
        abilities: {
          ...
          active: {
            name: 'Darkness Falls',
            effect: 'Success roll: debuff #spec Enemies with Blind until Ariadne becomes active',
          },
          ultimate: {
            name: 'Foreseer\'s Favour',
            effect: 'Once per Room: Ariadne gains the following ability based on the current Room Type:<br>'
              + 'Mob/Boss Room - Ariadne gains #spec DMG until Ariadne Dies or leaves the current Room<br>'
              + 'Trap Room - Ariadne gains + #spec Success roll for the Room<br>'
      ...
      'Psykoshka': {
        ...
        abilities: {
          ...
          ultimate: {
            name: 'Loyalty',
            effect: 'Ally Users gain #spec Special Stat Lvl until Psykoshka becomes active',
            recharge: 8,
          },
        },
      },
    ...
    characters: {
      'Grimwulf kaiser': {
        ...
        abilities: {
          passive: {
            name: 'Battle Howl',
            effect: 'Gain + #spec Decisive roll',
          },
          active: {
            name: 'Duality',
            effect: 'Deal half of #dmg + #spec (rounded up) to 2 different Enemies ',
          },
          ultimate: {
            name: 'Hellhound',
            effect: 'If no Hellhound Tokens exists: spawn a Hellhound Token with #spec DMG and #spec Max HP. Hellhound Token is treated as an ally User (cannot acquire or hold Items). If Grimwulf Kaiser is targeted for an attack: Hellhound Token is attacked instead',
            recharge: 5,
          },
        },
      },
      'Jackal': {
        ...
        abilities: {
          ...
          active: {
            name: 'Distortion',
            effect: 'Deal #spec DMG to all Enemies with debuffs',
          },
          ultimate: {
            name: 'EQ',
      ...
      'Vulcana': {
        ...
        abilities: {
          ...
          active: {
            name: 'Fever',
            effect: 'Vulcana gains #spec DMG for the next attack',
          },
          ultimate: {
            name: 'Pyreball',
            effect: 'Success roll: Vulcana deals DMG + #spec to 1 Enemy. This ability repeats 3 times',
            recharge: 6,
          },
        },
      },
    ...
    characters: {
      'Misteyes Snow': {
        ...
        abilities: {
          passive: {
            name: 'Empath',
            effect: 'When Misteyes Snow Recovers HP: Recover 1 ally User for the same amount + #spec HP',
          },
          active: {
            name: 'Erasure',
            effect: 'Remove all debuffs on #spec ally Users',
          },
          ultimate: {
            name: 'Light of Life',
      ...
      'Dexler': {
        ...
        abilities: {
          ...
          active: {
            ...
            effect: 'Discard 1 Consumable Item: deal 5 + #spec DMG to 1 Enemy or 1 ally User Recovers 5 + #spec HP',
          },
          ultimate: {
            name: 'The Creator',
      ...
      'Faerie': {
        ...
        abilities: {
          passive: {
            ...
            effect: 'While Faerie is at Max HP: Faerie and ally Users gain + 1 Success roll and #room DMG',
          },
          active: {
            name: 'Sacred Medicine',
            effect: '1 User Recovers #spec HP',
          },
          ultimate: {
            name: 'Faeth',
    ...
    characters: {
      'Ein': {
        ...
        abilities: {
          passive: {
            ...
            effect: 'When Ein or an ally User pass a Success roll: Ein gains #spec DMG. This effect can stack but resets if Ein leaves the current Room, Dies or if a Success roll fails',
          },
          active: {
            name: 'Gamble',
            effect: 'Ally Users gain + #spec Success roll. This ability can be used in a Trap Room and lasts until Ein becomes active',
          },
          ultimate: {
            name: 'Shadow Sneak',
      ...
      'Zuciel': {
        ...
        abilities: {
          ...
          active: {
            name: 'Sloth',
            effect: 'Zuciel Recovers #spec HP',
          },
          ultimate: {
            name: 'Wrath',
            effect: 'If all ally Users are active: Zuciel can attack #spec Enemies once each. Discard #spec G. All ally Users become inactive',
            recharge: 5,
          },
        },
      },
      'Marina': {
        ...
        abilities: {
          passive: {
            ...
            effect: 'When an Item is acquired: Marina can discard the Item and acquire a new one instead. This can be repeated #spec times',
          },
          active: {
          ...
          ultimate: {
            ...
            effect: 'Once per Room: all ally Users’ Ultimate Gauge recharge by #spec ',
            recharge: 10,
          },
        },
      },
