      ...
      'Ariadne': {
        ...
        abilities: {
          ...
          ultimate: {
            ...
            effect: "Once per Room: Ariadne gains the following ability based on the current Room Type: Mob/Boss Room - Once per Room: Ariadne gains (Intelligence Lvl) DMG until Ariadne Dies or leaves the current Room. Trap Room - Ariadne gains + (Intelligence Lvl) Success roll for the Room. Treasure Room - Once per Room, If an Item is acquired: Acquire 1 Item",
            recharge: 5,
          },
        },
      },
